...
module JsonMarshalling =
    ...
    type internal CommitmentPubKeyConverter() =
        ...
        override __.ReadJson(reader: JsonReader, _: Type, _: CommitmentPubKey, _: bool, serializer: JsonSerializer) =
        ...
        override __.WriteJson(writer: JsonWriter, state: CommitmentPubKey, serializer: JsonSerializer) =
